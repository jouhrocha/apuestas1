...
<div id="cdf_shortcode_dialog" class="flytonic_sc_editor" title="Custom Buttons" style="display:none;">
	...
	<div>
    	...
    	<label for=""><?php _e('Button Text', 'sportsnews'); ?></label>

    	<input class="fly_textinput" type="text" name="fly_button_text" id="text" size="40">

    	<p><?php _e('Enter Button Text', 'sportsnews'); ?></p>
	...
	<div>
    	...
    	<label for=""><?php _e('Button URL', 'sportsnews'); ?></label>

    	<input class="fly_textinput" type="text" name="fly_button_text" id="linkurl" size="40">

    	<p><?php _e('Enter Button URL', 'sportsnews'); ?></p>
	...
	<div>
    	...
    	<label><?php _e('Size of Button', 'sportsnews'); ?></label>

    	<select class="fly_textinput" name="size" id="size">

    	     	<option value="reg"><?php _e('Regular', 'sportsnews'); ?></option>

		<option value="sm"><?php _e('Small', 'sportsnews'); ?></option>

		<option value="med"><?php _e('Medium', 'sportsnews'); ?></option>

               	 <option value="lg"><?php _e('Large', 'sportsnews'); ?></option>
	...
	<div>
    	...
    	<select class="fly_textinput" name="icon" id="icon">
    	     	...
    	     	<option value="none"><?php _e('None (Default)', 'sportsnews'); ?></option>

               	 <option value="darrow"><?php _e('Down Arrow', 'sportsnews'); ?></option>

		<option value="info"><?php _e('Info', 'sportsnews'); ?></option>

		<option value="error"><?php _e('Error', 'sportsnews'); ?></option>

		<option value="check"><?php _e('Check', 'sportsnews'); ?></option>

   		<option value="warning"><?php _e('Warning', 'sportsnews'); ?></option>
	...
	<div>
    	...
    	<label><?php _e('Text Color', 'sportsnews'); ?></label>

    	<select class="fly_textinput" name="text_color" id="text_color">

    	     	<option value="lgt"><?php _e('Light', 'sportsnews'); ?></option>

                <option value="drk"><?php _e('Dark', 'sportsnews'); ?></option>
	...
	<div>
    	...
    	<label><?php _e('Background Color', 'sportsnews'); ?></label>

    	<select class="fly_textinput" name="bg_color" id="bg_color">

    	     	<option value="normal"><?php _e('Normal', 'sportsnews'); ?></option>
...
<option value="black">B.on/option>

		<option value="custom"><?php _e('Custom', 'sportsnews'); ?></option>
	...
	<div id="cdf_bg_color_custom" style="display:none;">
    	...
    	<label for="tag-name"><?php _e('Custom Background Color', 'sportsnews'); ?></label>

    	<input type="text" name="bg_color_custom" id="bg_color_custom" class="cdf-bg-color-field" size="40" />

    	<p><?php _e('Select or enter a custom background color for the button', 'sportsnews'); ?></p>
...
jQuery(document).ready( function() {
    ...
    jQuery('#text_color').on('change',function(){
    ...
    jQuery('#bg_color').on('change',function(){

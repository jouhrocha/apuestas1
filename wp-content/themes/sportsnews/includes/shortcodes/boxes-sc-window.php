...
.flytonic_sc_editor p {margin:0 0 10px 0; padding:0; font-size:12px; font-style:italic; color:#666;}	
 ...
 <div id="fly_boxes" class="flytonic_sc_editor" title="Alert Boxes Shortcode"  style="display:none">
	...
	<div>
    	<label><?php _e('Icon', 'sportsnews'); ?></label>
    	<select class="fly_textinput" name="box_style" id="box_style">
    	     	<option value="info"><?php _e('Info Box', 'sportsnews'); ?></option>
		<option value="check"><?php _e('Check Box', 'sportsnews'); ?></option>
               	 <option value="download"><?php _e('Download Box', 'sportsnews'); ?></option>
		<option value="error"><?php _e('Error Box', 'sportsnews'); ?></option>
   		<option value="alert"><?php _e('Alert Box', 'sportsnews'); ?></option>
    	</select>

	</div>

	<div>
    	<label><?php _e('Alert Box Text', 'sportsnews'); ?></label>
	<textarea class="fly_textinput" id="box_body" style="width: 100%; height: 80px;"></textarea>
	<p><?php _e('Enter text here or within the post itself', 'sportsnews'); ?></p>
   	</div> 
